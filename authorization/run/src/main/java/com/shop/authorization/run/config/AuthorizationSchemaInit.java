package com.shop.authorization.run.config;
...
@Import({AuthorizationSchemaInit.SpringLiquibaseDependsOnPostProcessor.class})
public class AuthorizationSchemaInit {
