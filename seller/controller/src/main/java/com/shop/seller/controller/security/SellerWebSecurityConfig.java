package com.shop.seller.controller.security;
...
public class SellerWebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests( request -> request
                        ...
                        .hasAnyAuthority(UsersRoles.ADMIN)
                        .requestMatchers("/seller/home/**")
                        .hasAnyAuthority(UsersRoles.ADMIN, UsersRoles.SELLER)
                        .requestMatchers("/api/**")
